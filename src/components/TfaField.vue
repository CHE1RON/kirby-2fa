...
export default {
  ...
  methods: {
    ...
    verifyCode() {
      ...
      this.$api
        ...
        .then(({ verify }) => {
          if (verify) {
            this.userHasTwoFactorAuth = verify;
    ...
    disabletfa() {
      ...
      this.$api
        ...
        .then(({ disabled }) => {
          if (disabled) {
            this.userHasTwoFactorAuth = !disabled;
  ...
  computed: {
    ...
    codeField() {
      return {
        name: "code",
        label: "The code shown in your app",
        minLength: 6,
        maxLength: 6,
        counter: false,
      };
